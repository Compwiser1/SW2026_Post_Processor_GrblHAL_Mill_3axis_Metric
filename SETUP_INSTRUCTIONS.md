...
**draft** release with a source zip attached (`SW26_GrblHAL_Mill_3axis_Metric-v1.0.0.zip`).
...
That publishes the release with both the source zip and the `.ctl`
attached. Every release after this one goes through
